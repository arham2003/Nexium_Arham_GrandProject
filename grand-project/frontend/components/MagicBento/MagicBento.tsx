...
const cardData: BentoCardProps[] = [
  {
    ...
    description:
      "Visualize user interactions and track engagement metrics live.",
    label: "Analytics",
  },
  {
    color: "#060010",
    ...
    description:
      "Your data, organized and actionable with built-in intelligence.",
    label: "Control Center",
  },
  {
    color: "#060010",
    title: "Collaborative Workspace",
    description: "Comment, share, and co-create with your team in real time.",
    label: "Team Sync",
  },
  {
    color: "#060010",
    ...
    description:
      "Automate tasks using AI triggers and conditional logic flows.",
    label: "Productivity",
  },
  {
    color: "#060010",
    ...
    description:
      "Seamlessly connect with tools like Notion, Slack, and Zapier.",
    label: "Ecosystem",
  },
  {
    color: "#060010",
    ...
    description:
      "Secure user data with encryption, auth guards, and role access.",
    label: "Trust & Safety",
  },
];
